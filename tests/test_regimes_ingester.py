...
class TestRegimesIngester(unittest.TestCase):
    ...
    def test_date_range_processing(self):
        ...
        mock_model_conn.cursor.return_value.__enter__ = Mock(return_value=mock_model_cursor)
        ...
        mock_cursor.fetchmany.side_effect = [mock_data[:2], mock_data[2:4], mock_data[4:], []]
    ...
    def test_checkpoint_resume(self):
        ...
        query_args = mock_cursor.execute.call_args
        self.assertEqual(query_args[0][1][0], date(2024, 1, 13))  # Start from day after checkpoint
    
    def test_incremental_load(self):
        """Test incremental load functionality."""
        # Mock getting latest date
        self.mock_model_db.execute_query.return_value = [{'max_date': date(2024, 1, 10)}]
    ...
    def test_duplicate_handling(self):
        ...
        mock_data = [
            ...
            (duplicate_date, {}, {}, {}, {}, {}, [0.2]*5, None, None),  # Different vector but same date
