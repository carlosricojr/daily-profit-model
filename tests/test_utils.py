...
class TestLoggingConfig(unittest.TestCase):
    ...
    def test_basic_logging_setup(self):
        ...
        logger = setup_logging(log_level="INFO", log_file="test", log_dir=self.temp_dir)
...
class TestMetrics(unittest.TestCase):
    ...
    def test_metrics_with_labels(self):
        ...
        self.metrics.increment_counter(
            "api_requests", 1, {"endpoint": "/users", "method": "GET"}
        )
        self.metrics.increment_counter(
            "api_requests", 1, {"endpoint": "/users", "method": "POST"}
        )

        metrics_data = self.metrics.get_metrics()
        self.assertIn(
            "api_requests{endpoint=/users,method=GET}", metrics_data["counters"]
        )
        self.assertIn(
            "api_requests{endpoint=/users,method=POST}", metrics_data["counters"]
        )
...
class TestConfigValidation(unittest.TestCase):
    ...
    def test_required_field_validation(self):
        ...
        self.assertIn(
            "Required configuration 'TEST_REQUIRED' is missing", self.validator.errors
        )

    def test_optional_field_with_default(self):
        """Test optional field with default value."""
        field = ConfigField(
            name="TEST_OPTIONAL", required=False, default="default_value", type=str
        )
    ...
    def test_type_conversion(self):
        ...
        self.assertEqual(
            self.validator.validate_field(field_list), ["item1", "item2", "item3"]
        )
    ...
    def test_choices_validation(self):
        ...
        field = ConfigField(
            name="TEST_CHOICE", type=str, choices=["option1", "option2", "option3"]
        )
    ...
    def test_numeric_range_validation(self):
        ...
        self.assertIsNone(value)
        self.assertTrue(
            any("below minimum" in error for error in self.validator.errors)
        )
        ...
        self.assertIsNone(value)
        self.assertTrue(
            any("above maximum" in error for error in self.validator.errors)
        )
    ...
    def test_custom_validator(self):
        ...
        self.assertIsNone(value)
        self.assertTrue(
            any("Custom validation failed" in error for error in self.validator.errors)
        )
...
class TestAPIClientEnhancements(unittest.TestCase):
    ...
    def test_pagination_handling(self, mock_session_class):
        ...
        response1.json.return_value = {
            "Status": "ok",
            "Data": {"data": [{"id": 1}, {"id": 2}], "total": 4, "skip": 0, "limit": 2},
        }
        response1.headers = {}
        response1.text = ""
        ...
        response2.json.return_value = {
            "Status": "ok",
            "Data": {"data": [{"id": 3}, {"id": 4}], "total": 4, "skip": 2, "limit": 2},
        }
        response2.headers = {}
        response2.text = ""
        ...
        response3.json.return_value = {
            "Status": "ok",
            "Data": {"data": [], "total": 4, "skip": 4, "limit": 2},
