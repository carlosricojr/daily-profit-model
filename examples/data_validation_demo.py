...
from preprocessing.data_quality_rules import (
    get_rules_for_table, get_critical_rules
)
...
def demo_data_validation():
    ...
    for result in results:
        status_symbol = {"PASSED": "✅", "WARNING": "⚠️", "FAILED": "❌"}[result.status.name]
...
def demo_data_profiling():
    ...
    mock_db_manager.model_db.execute_query.side_effect = [
        ...
        [
            ...
            {'column_name': 'current_equity', 'data_type': 'numeric', 'is_nullable': 'YES'},
    ...
    for column, null_count in profile.null_counts.items():
        null_pct = (null_count / profile.row_count * 100) if profile.row_count > 0 else 0
