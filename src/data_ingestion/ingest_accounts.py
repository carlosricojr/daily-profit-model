...
class AccountsIngester(BaseIngester):
    ...
    def _validate_record(self, record: Dict[str, Any]) -> Tuple[bool, List[str]]:
        ...
        if (starting_balance is not None and current_balance is not None and 
            current_balance < starting_balance and not breached):
    ...
    def _transform_record(self, record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'max_daily_drawdown_pct': self._safe_float(record.get('maxDailyDrawdownPct')),
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Ingest accounts data with enhanced features')
