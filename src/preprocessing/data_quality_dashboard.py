...
class DataQualityDashboard:
    ...
    def _setup_layout(self):
        ...
        self.app.layout = dbc.Container(
            [
                                    ...
                                    [
                                        dbc.CardBody(
                                            [
                                                ...
                                                html.P(
                                                    "hours old", className="text-center"
                                                ),
                                            ]
                                        )
                                    ]
                ...
                # Charts
                dbc.Row(
                    [dbc.Col([dcc.Graph(id="quality-timeline")], width=12)],
                    className="mb-4",
                ),
                dbc.Row(
                    [
                        dbc.Col([dcc.Graph(id="validation-heatmap")], width=6),
                        dbc.Col([dcc.Graph(id="anomaly-distribution")], width=6),
                    ],
                    className="mb-4",
                ),
                dbc.Row(
                    [
                        dbc.Col([dcc.Graph(id="data-volume-chart")], width=6),
                        dbc.Col([dcc.Graph(id="late-data-chart")], width=6),
                    ],
                    className="mb-4",
                ),
                # Detailed tables
                dbc.Row(
                    [dbc.Col([html.H3("Recent Alerts"), html.Div(id="alerts-table")])]
                ),
                # Auto-refresh
                dcc.Interval(
    ...
    def _setup_callbacks(self):
        ...
        def update_anomaly_distribution(n, start_date, end_date):
            ...
            fig.add_trace(go.Pie(labels=data["types"], values=data["counts"], hole=0.3))

            fig.update_layout(title="Anomaly Distribution by Type", height=400)
        ...
        def update_data_volume_chart(n, start_date, end_date):
            ...
            for table in data["tables"]:
                fig.add_trace(go.Bar(x=data["dates"], y=data[table], name=table))
    ...
    def _get_overview_metrics(self, start_date: str, end_date: str) -> Dict[str, Any]:
        ...
        validation_failures = (
            validation_result[0]["failures"] if validation_result else 0
        )
    ...
    def _get_quality_timeline_data(
    ...
    def _get_validation_heatmap_data(
        self, start_date: str, end_date: str
    ) -> Dict[str, Any]:
    ...
    def _get_anomaly_distribution_data(
        self, start_date: str, end_date: str
    ) -> Dict[str, List]:
    ...
    def _get_recent_alerts(
        ...
        return self.db_manager.model_db.execute_query(
