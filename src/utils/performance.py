...
class PerformanceProfiler:
    ...
    def stop(self) -> Dict[str, Any]:
        ...
        results = {"name": self.name, "profile": profile_output}
        ...
        logger.info(f"Stopped profiling: {self.name}", extra={"extra_fields": results})
...
def profile_function(
    name: Optional[str] = None, track_memory: bool = True, log_results: bool = True
):
    """
...
def memory_monitor(name: str):
    ...
    try:
        ...
        logger.info(f"Memory usage for {name}", extra={"extra_fields": stats})
