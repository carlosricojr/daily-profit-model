...
def setup_logging(
    ...
    if log_file:
        ...
        root_logger.info(
            "Logging initialized",
            extra={'log_level': log_level, 'console_only': True}
        )
...
def get_logger(name: Optional[str] = None, **kwargs) -> Union[logging.Logger, BoundLogger]:
    """
...
def log_metrics(logger: Union[logging.Logger, BoundLogger], 
                operation: str,
